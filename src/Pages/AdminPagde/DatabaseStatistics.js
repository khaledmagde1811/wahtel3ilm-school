...
const DatabaseStatistics = () => {
  ...
  useEffect(() => {
    ...
    if (!supabaseUrl || !supabaseKey) {
      setError('يرجى التأكد من وجود متغيرات البيئة الخاصة بـ Supabase في ملف .env');
      setLoading(false);
      return;
    }
  ...
  const refreshStatistics = () => {
    setLoading(true);
    window.location.reload(); // إعادة تحميل الصفحة لجلب البيانات مرة أخرى
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 flex justify-between items-center">
          <div>
            ...
            <p className="text-lg" style={{ color: '#665446' }}>
              نظرة شاملة على إحصائيات قاعدة البيانات (البيانات الحقيقية من Supabase)
            </p>
          </div>
        ...
        {loading && (
          <div className="flex justify-center items-center py-12">
            ...
            <span className="ml-3 text-lg" style={{ color: '#665446' }}>جاري تحميل الإحصائيات من Supabase...</span>
          </div>
        )}
          ...
          <>
            ...
            <div className="text-center mt-8">
              <p className="text-sm" style={{ color: '#665446' }}>
                ...
                <br />
                <span className="text-xs">البيانات محدثة مباشرة من Supabase</span>
              </p>
            </div>
          </>
        )}
